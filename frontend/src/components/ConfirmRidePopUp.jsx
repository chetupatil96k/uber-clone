  ...
  return (
   ...
   <div className='flex gap-2 flex-col justify-between items-center'>
     ...
     <form onSubmit={(e)=>{
        ...
        <input value={otp} onChange={(e)=> setOtp(e.target.value)} className='bg-[#eee] px-12 py-2 text-lg rounded-lg w-full mt-5 font-mono ' type="text" placeholder='Enter OTP' />
       <div className=' mt-10 gap-5 flex'>
       
        <Link to='/captain-riding' className='w-full flex justify-center px-10 p-4 text-lg rounded-lg font-semibold text-white bg-green-600'>Confirm</Link> 
        <button onClick={()=>{
         props.setConfirmRidePopUpPanel(false)
         props.setRidePopUpPanel(false)
          
        
       }} className='w-full px-10 p-1 rounded-lg font-semibold text-white bg-red-600'>Cancle  Ride</button>
