   ...
   <div className='flex gap-2 flex-col justify-between items-center'>
       ...
       <div className='w-full mt-5'>
         ...
         <div>
          ...
          <p className='text-base -mt-1 text-gray-600'>17th Cross Rd,PWD Quarters,1st Sector,HSR Layout,Bengluru,Karnata</p>
         </div>
         </div>
