  ...
  return (
    <div>
     ...
     <div className='flex gap-2 flex-col justify-between items-center'>
         ...
         <div className='flex w-full mt-5 gap-5 items-center justify-between'>

         <button onClick={()=>{
            props.setConfirmRidePopUpPanel(true)
            
          
         }} className='  w-full p-3 px-6 rounded-lg font-semibold text-white bg-green-300'>Accept </button> 
      <button onClick={()=>{
           props.setRidePopUpPanel(false)
            
          
         }} className=' w-full p-3 px-6 rounded-lg font-semibold text-gray-700 bg-gray-300'>Ignore</button>
